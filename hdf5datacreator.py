...
df = pd.read_csv('C:/Work/waste_classifier/Wastemanagement/Wastemanagement/datasets/train.csv')
...
# validation data
split = train_test_split(trainPaths, trainLabels,test_size=4248, stratify=trainLabels,random_state=42)
...
f = open("C:/Work/waste_classifier/Wastemanagement/Wastemanagement/output/waste_mean.json", "w")
